...
create table tblType(
    -- num number
    --num number
    --num number(3) --  -999 ~ +999까지 집어넣을수 있다는 뜻 .정수
    --unm number(4, 2) -- -99.99 ~ + 99.99
  
  
    --txt char(10)  -- 최대 10바이트까지의 문자열 -> 보통 이걸 쓴당
...
insert into tblType (txt) values ('abcdabcdaba'); --11바이트

insert into tblType (txt) values ('홍길동입니다.'); --(actual: 19, maximum: 10) 한글은 한글자에 3바이트
insert into tblType (txt) values ('홍길동');
...
DB Client Tools
1. SQL Developer : 오라클이 제공, 무료,그럭저럭 쓸만함
2. SQL *PLUS : 오라클 제공, 무료, 오라클 설치될 때 같이 설치됨. CLIdds
3. SQLGate
4. Orange
5. DBeaver
6. ..
